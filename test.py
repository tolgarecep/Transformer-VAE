...
def encode(sents):
    ...
    batches, order = get_tokenized_batches(sents, vocab, 'transformer', args.batch_size, device)
    z = []
...
if __name__ == '__main__':
    ...
    if args.evaluate:
        ...
        batches, _ = get_tokenized_batches(sents, vocab, 'transformer', args.batch_size, device)
